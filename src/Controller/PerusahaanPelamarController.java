...
import View.PerusahaanPelamarpage;
 ...
 * @author Diah Ajeng
 */
public class PerusahaanPelamarController extends MouseAdapter implements ActionListener{

    private PerusahaanPelamarpage view;
    private Aplikasi model;
    private Perusahaan p;

    public PerusahaanPelamarController(Aplikasi model, Perusahaan p) {
        this.model = model;
        this.p = p;
        view = new PerusahaanPelamarpage();
