                ...
                case 1: // Daftar Lowongan Kerja
                        ...
                        if(perusahaanList.size() == 0 ){
                            ...
                            for(int i=0;i<perusahaanList.size();i++){
                                ...
                                for (int j = 0; j < perusahaanList.get(i).getDaftarLowongan().size(); j++) {
                                ...
                                case 1 :    // Login Perusahaan
                                            ...
                                            if(find){
                                                ...
                                                while(pilihan != 0){
                                                    ...
                                                    switch(pilihan){
                                                        case 1 : 
                                                            if(perusahaanList.get(i).getDaftarLowongan().size() == 0){
                                                                System.out.println("Tidak ada lowongan");
                                                                break;
                                                            }
                                                            for (int j = 0; j < perusahaanList.get(i).getDaftarLowongan().size(); j++) {
                                                                if(perusahaanList.get(i).getdaftarLowongan(j).getBerkasMasuk().size() == 0){
                                                                    System.out.println("Tidak ada berkas masuk pada lowongan ini");
                                                                }else{
                                                                    for (int k = 0; k < perusahaanList.get(i).getdaftarLowongan(j).getBerkasMasuk().size(); k++) {
