...
public class AplikasiKonsol {
    ...
    public void mainMenu() throws ParseException{
        ...
        // coba bikin perusahaan
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        Date date2=null;
        
        Perusahaan p = new Perusahaan(perusahaanList.size()-1, "PT", "08", "Perbankan", "Keuangan", 5, "Diah", "diahajeng", "apa");
        perusahaanList.add(p);
        Perusahaan p1 = new Perusahaan(perusahaanList.size()-1, "Psahdasd", "08", "Perbankan", "Keuangan", 5, "Diah", "ajeng", "apa");
        ...
        // buat pelamar
        Pelamar pel = new Pelamar(pelamarList.size()-1, "Ajeng", "diahajeng","apa");
        pelamarList.add(pel);
                                                        ...
                                                        case 2 : // Lihat Lowongan
                                                            if(perusahaanList.get(i).getDaftarLowongan() == null){
                                                                ...
                                                                for (int j = 0; j <= jmlLow-1; j++) {
                                                                    ...
                                                                    System.out.println("\t Deadline : " + dateFormat.format(perusahaanList.get(i).getdaftarLowongan(j).getDeadline()) + "\n");
                                                                    //disini blm selesai
//                                                                    System.out.println(perusahaanList.get(i).getdaftarLowongan(j).getBerkasMasuk());
//                                                                    if(perusahaanList.get(i).getdaftarLowongan(j).getBerkasMasuk() == null){
//                                                                        System.out.println("Tidak ada berkas masuk pada lowongan ini");
//                                                                    }else{
//                                                                        int jmlBerkas = perusahaanList.get(i).getdaftarLowongan(j).getBerkasMasuk().size();
//                                                                        for (int k = 0; k <= jmlBerkas-1; k++) {
//                                                                            System.out.println("Berkas Masuk ke-" + (k+1));
//                                                                            System.out.println(perusahaanList.get(i).getdaftarLowongan(j).getBerkasMasuk(k).getIdBerkas());
//                                                                        }
//                                                                    }
                                                                }
                                                            }
